...
console.log(createMenuItem("philly cheesesteak", 7, "lunch"));
console.log(createMenuItem("brownie supreme", 5, "dessert"));
...
reviews.push({name: "Jennifer", rating: 5, feedback:"Great cast! Lot's of energy"})
