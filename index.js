...
*/
const newItemOne = createMenuItem('Croissant', 5, 'Breakfast');
const newItemTwo = createMenuItem('Burger', 15, 'Lunch');
const newItemThree = createMenuItem('Brownie', 7, 'Desserts');

console.log(newItemOne);
console.log(newItemTwo);
console.log(newItemThree);
...
export const burger = {
  ...
  discount: function (string){
    if(string.includes('teacher' || 'student')){
...
const newReview = {
  name: 'Jessica',
  rating: 1,
  feedback: 'My kids could have cooked a better meal'
}
